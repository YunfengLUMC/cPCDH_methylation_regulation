...
maskProbes_450 <- as.data.frame(fread(file = "Input_01_HM450.hg19.manifest.tsv"))
```
...
maskProbes_450 <- filter(maskProbes_450,MASK_general=="TRUE")
mvalues_BIOS <- mvalues[!(rownames(mvalues) %in% maskProbes_450$probeID),] 
